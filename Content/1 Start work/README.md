...
| 6 | **JavaScript _(ES6)_**        | charalampos karypidis | Полезные снипиты для JS ускорят и упростят написание кода | [link](https://marketplace.visualstudio.com/items?itemName=xabikos.JavaScriptSnippets) |
