...
Уровень служб приложений системы AppBase взаимодействует с уровнем приложений AppBase (системные веб-службы AppBase), уровнем инфраструктуры AppBase, общей инфраструктурой и уровнем данных.
