...
## [Локализация различных лэйблов или полей на формах/гридах](#Локализация-различных-лэйблов-или-полей-на-формах)
## [Локализация основного интерфейса _(пункты меню)_](#Локализация-основного-интерфейса)
