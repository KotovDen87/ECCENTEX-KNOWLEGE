...
## [Локализация различных лэйблов или полей на формах/гридах](#локализация-различных-лэйблов-или-полей-на-формахгридах-1)
## [Локализация основного интерфейса _(пункты меню)_](#локализация-основного-интерфейса-пункты-меню-1)
